...
*/
carro.adicionarPessoas = function(quantas) {
  if (
    quantas < 0 &&
    ...
    return "só cabem mais " + quantasCabemAinda + " " + pessoas;
  } else {
    carro.quantidadePessoas += quantas;
    return "Ja temos " + carro.quantidadePessoas + " no carro!";
  }
...
carro.obterMarcaModelo(); //"este carro é um ferrari f50"
...
carro.adicionarPessoas(-4); //"Ja temos 1 no carro!"
